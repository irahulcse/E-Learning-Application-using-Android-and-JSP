...
.button7 {background-color: #555555;} /* Black */
...
<div>
<div align="center">
  <form action="ClassApplication/navclass.jsp">
   <button class="button button3" style="width:350px">CBSE CLASS 1-3</button>
	</form> 
	</div>
	<div align="center">
  <form action="MainsApplication/BookApplication.jsp">
   <button class="button button2" style="width:350px">JEE MAINS</button>
	</form>  
	</div>
	<div align="center">
  <form action="AdvanceApplication/BookApplication.jsp">
   <button class="button button3" style="width:350px">JEE ADVANCE</button>
	</form>  
	</div>
  <div align="center">
  <form action="AptiApplication/BookApplication.jsp">
   <button class="button button2" style="width:350px">Quantitative Aptitude</button>
	...
	<div align="center">
	<form action="GatePreviousApplication/BookApplication.jsp">
