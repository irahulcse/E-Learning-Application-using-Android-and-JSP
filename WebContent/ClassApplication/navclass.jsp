...
<div align="center">
  ...
  <br>
  <br>
  <form action="math1.jsp">
   <button class="button button4" style="width:350px">CLASSES 1-3</button>
	</form> 
  <br>
  <form action="math4.jsp">
   <button class="button button" style="width:350px">CLASSES 4-10</button>
	</form>  
	<br>
	<form action="math7.jsp">
   <button class="button button4" style="width:350px">CLASS 11-12</button>
	</form>   
  </div>
</div>
</body>
