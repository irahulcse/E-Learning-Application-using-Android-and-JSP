...
<div align="center">
  <div align="center">
  <form action="Class1/math.jsp">
  <br>
  <br>
  <br>
   <button class="button button4" style="width:350px">MATHS AGE 4-5 EASY</button>
	</form> 
  <br>
  <form action="ClassApplication/Class4/math.jsp">
   <button class="button button" style="width:350px">MATHS AGE 4-5 DIFFICULT</button>
	</form>  
	<br>
	<form action="ClassApplication/Class4/math.jsp">
   <button class="button button" style="width:350px">MATHS AGE 4-5 DIFFICULT</button>
