...
<div align="center">
  <div align="center">
  <form action="math4easy.jsp">
  <br>
  <br>
  <br>
   <button class="button button4" style="width:350px">MATHS FOR KIDS 4-5 EASY</button>
	</form> 
  <br>
  <form action="math4medium.jsp">
   <button class="button button3" style="width:350px">MATHS AGE 4-5 MEDIUM</button>
	</form>  
	<br>
	<form action="math4difficult.jsp">
   <button class="button button2" style="width:350px">MATHS AGE 4-5 DIFFICULT</button>
	</form>  
  </div>
</div>
</body>
