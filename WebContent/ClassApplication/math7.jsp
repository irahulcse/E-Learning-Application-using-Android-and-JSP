...
<div align="center">
  <div align="center">
  <form action="math7easy.jsp">
  <br>
  <br>
  <br>
   <button class="button button4" style="width:350px">MATHS FOR KIDS 7-9 EASY</button>
	</form> 
  <br>
  <form action="math7medium.jsp">
   <button class="button button3" style="width:350px">MATHS AGE 7-9 MEDIUM</button>
	</form>  
	<br>
	<form action="math7difficult.jsp">
   <button class="button button2" style="width:350px">MATHS AGE 7-9 DIFFICULT</button>
	</form>  
  </div>
</div>
</body>
